    ...
    return (
      <Block>
        <Block center bottom flex={0.4}>
          <Text h2 center bold primary style={{fontSize:23 }}>
            INDUSTRIAL AUTOMATION AND PRODUCTION MANAGEMENT SYSTEM
            {/* <Text h1 primary> Greener.</Text> */}
          </Text>
          <Text h2 center bold primary style={{ marginTop: theme.sizes.padding / 5,fontSize:23 }}>
           (IAPMS)
          </Text>
        </Block>
        <Block center middle>
        ...
        <Block middle flex={0.5} margin={[0, theme.sizes.padding * 2]}>
          ...
          <Button shadow onPress={() => navigation.navigate('AddEdit')}>
...
Welcome.defaultProps = {
  illustrations: [
    { id: 1, source: require('../assets/images/illustration.png') },
    { id: 2, source: require('../assets/images/illustration_3.png') },
    { id: 3, source: require('../assets/images/illustration_4.png') },
    { id: 4, source: require('../assets/images/illustration_2.png') },
    { id: 5, source: require('../assets/images/illustration_1.png') },
